...
const Svg = (props: any) => <View style={{ width: '100%', height: props.height }}>{props.children}</View>;

const Circle = (props: any) => {
  const { cx, cy, r, stroke, strokeWidth, fill, strokeDasharray, strokeDashoffset, strokeLinecap } = props;
